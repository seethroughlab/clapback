...
**`ADR-0011` is proposed, not accepted** (2026-09-13), and is the first record about who the commons
is *for*. It says the commons is the product and `clapback-cli` is the reference client, not the
...
supersedes `ADR-0009`'s account of how a contributor arrives; `ADR-0009` points 2 to 9 stand. Do not
build the client package or any plugin until it is decided.
